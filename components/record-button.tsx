...
export const RecordButton = ({
  ...
  return (<IconButton
      ...
      sx={{
        ...
        height: '150px',
        bottom: '35vh',
        boxShadow: isProcessing ? 'rgb(74, 24, 128) 0px 0px 25px 7px inset, rgb(74, 24, 128) 0px 0px 6px 1px' : (isRecording ? 'rgb(74, 24, 128) 0px 0px 25px 7px inset, rgb(74, 24, 128) 0px 0px 5px 0px' : 'inset 0px 0px 25px 7px #03001d, 0px 0px 2px 0px #03001d'),
        backgroundColor: isProcessing ? '#dae1d3' : (isRecording ? '#702eb8' : '#0080ff'),
        _hover: { 
          backgroundColor: isProcessing ? '#cce0b8' : (isRecording ? '#702eb8' : '#03001d') ,
